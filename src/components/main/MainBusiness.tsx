  ...
  return (
    <section className="mt-20 container px-4">
      ...
      <div className="mt-11 flex flex-col gap-4">
        <div className="bg-[url('/images/background/bg_business1.png')] rounded-xl w-full relative bg-cover bg-center h-[500px]">
          <div className="bg-white rounded-tr-3xl rounded-bl-xl w-2/3 absolute bottom-0 left-0 px-12 py-12">
            <h3 className="text-2xl font-bold">
              지방교육행정기관 재정투자사업 투자심사 지원·관리
            </h3>
        ...
        <div className="bg-[url('/images/background/bg_business2.png')] rounded-xl relative bg-cover bg-center h-[200px] flex flex-row justify-between items-center px-24">
        ...
        <div className="bg-[url('/images/background/bg_business3.png')] rounded-xl relative bg-cover bg-center h-[200px] flex flex-row justify-between items-center px-24">
